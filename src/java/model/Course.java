...
/**
 * Class that constructs a new course Course activities or sections are listed
 * by term
 *
...
public class Course extends AbstractCourse {
    ...
    /**
     * list of activities by term term0 - any term term 1 and 2 self explanatory
     * term3 are year-long "1-2" courses term4 are "other" termed courses eg.
     * distance education course with term C
     */
    ...
    /**
     * populates activity lists with all activities in the course, sorted by
     * term
     *
    ...
    private void populateActivities() throws Exception {
        ...
        for (Element element : elements) {
            ...
            if (!type.equals("Waiting List") && !type.equals("Distance Education") && !status.equals("Cancelled")) {
    ...
    private void checkUrl(Document courseDocument) throws BadAttributeValueExpException {
        ...
        if (elements.isEmpty()) {
            ...
            finishedLoading = true;
            throw new BadAttributeValueExpException("Add " + name + " Unsuccessful. Check your session! "
                    + "The requested course is either not being offered this session "
                    + "or is no longer offered at " + campus);
        }
    }
